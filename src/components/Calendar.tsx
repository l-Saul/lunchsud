        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-7 gap-2">
                ...
                return (
                    ...
                    key={`day-${index}`}
                    role="button"
                    onClick={() => {if (ocupado && ocupacao) {onSelectOcupado(ocupacao.nome)} else {onSelectDay(dia)}}}
                    ...
                    style={{
                        backgroundColor: ocupado ? 'var(--cal-ocupado)' : selecionado ? 'var(--cal-selecionado)' : 'var(--cal-disponivel)',
